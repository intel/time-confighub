...
from time_config_hub.orchestrator.ipc import start_orchestrator_server
...
class Service:
    ...
    def _start_orchestrator_server(self):
        ...
        """
        try:
            self._orchestrator_server = start_orchestrator_server()
